...
class SmartProcessorV5_1:
    """智能处理器 V5.1 - 控制台显示优化版本"""
    ...
    def process_unprocessed_announcements(self,
                                          ...
                                          max_count=10,
                                          task_type="未指定"):
        """处理未处理过的公告 - V5.1显示优化版本"""
        
        self.console.print_header(f"智能处理器 V5.1 - {task_type}")
...
def main():
    """主函数 - V5.1优化版"""
    processor = SmartProcessorV5_1()
    console = ConsoleHelper()
    
    while True:
        console.print_header("智能处理器 V5.1 - 控制台优化版")
        ...
        if choice == '1':
            ...
            date = input(f"{Fore.YELLOW}日期 (YYYYMMDD, 默认20250430):{Style.RESET_ALL} ") or "20250430"
