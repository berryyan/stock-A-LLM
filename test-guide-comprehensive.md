...
| Agent | 状态 | 主要功能 | 快速路径 |
|-------|------|----------|----------|
| SQL Agent | ✅ 已实现 | 结构化数据查询 | 10个快速模板 |
| RAG Agent | ✅ 已实现 | 文档检索分析 | 部分优化 |
| Financial Agent | ✅ 已实现 | 专业财务分析 | 计划优化 |
| Money Flow Agent | ✅ 已实现 | 资金流向分析 | 计划优化 |
| Hybrid Agent | ✅ 已实现 | 智能路由分发 | 路由优化 |
...
> 📌 **最新更新 (v2.1.8)**: 市值排名模板已扩展支持无数字默认前10、TOP格式等多种自然语言表达方式
